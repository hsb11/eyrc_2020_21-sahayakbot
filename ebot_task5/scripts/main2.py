...
def drop_conference():
    ...
    while x_check == 0:
        pass
    rospy.loginfo('Exited Conference')
...
def storee():
    ...
    while x_check == 0:
        pass
    rospy.loginfo("Store Room Detection point reached")
    ...
    while x_check == 0:
        pass
    rospy.loginfo("Store Room Detection point reached AGAIN")
...
def main():
    ...
    rospy.init_node('main2', anonymous=True)
    ...
    obj_req = ['FPGA Board', 'Coke', 'Adhesive']
    dest = ['Conference', 'Meeting', 'Conference']
